...
if (isloggedin() && !isguestuser()) {
    ...
    try{
        $course = $DB->get_record('course', array('idnumber' => 'CLR'));
    ...
    $templatecontext = [
        ...
        'logofooter' => $OUTPUT->image_url('FOSlogo-footer', 'theme_fos_space5'),
        'modules' => $modules

    ];
    echo $OUTPUT->render_from_template('theme_fos_space5/coursecategory', $templatecontext);
} else {
