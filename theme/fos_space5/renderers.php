...
class theme_fos_space5_core_course_renderer extends core_course_renderer
{
...
/**
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
       ...
       // echo("</pre>");
        ...
        $content .= get_string('available', 'theme_fos_space5') . ' ' . date('d-M-y',$course->startdate);
...
class theme_fos_space5_mod_assign_renderer extends mod_assign\output\renderer 
{
    ...
    public function render_assign_grading_summary(\assign_grading_summary $summary) {
        ...
        $o .= get_string('displaysummary', 'theme_fos_space5');
