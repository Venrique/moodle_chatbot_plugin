...
/**
 * Strings for component 'datafos', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_datafos
...
$string['availabletags_help'] = 'Tags are placeholders in the template, which will be replaced by datafos or other items, such as an edit icon, when entries are edited or viewed.
...
$string['createactivity'] = 'Create your own fields to collect datafos, or use a preset which includes fields already.';
$string['createfields'] = 'Create fields to collect different types of datafos.';
...
$string['csvfailed'] = 'Unable to read the raw datafos from the CSV file';
$string['csvfile'] = 'CSV or ZIP containing a CSV file';
$string['csvimport'] = 'CSV file import';
$string['csvimport_help'] = 'Entries may be imported via a plain text file with a list of field names as the first line, then the datafos, with one record per line.';
$string['csvwithselecteddelimiter'] = '<abbr title="Comma Separated Values">CSV</abbr>';
$string['datafos:addinstance'] = 'Add a new database';
$string['datafos:approve'] = 'Approve and undo approved entries';
$string['datafos:comment'] = 'Write comments';
$string['datafos:exportallentries'] = 'Export all database entries';
$string['datafos:exportentry'] = 'Export a database entry';
$string['datafos:exportownentry'] = 'Export own database entry';
$string['datafos:exportuserinfo'] = 'Export user information';
$string['datafos:managecomments'] = 'Manage comments';
$string['datafos:manageentries'] = 'Manage entries';
$string['datafos:managetemplates'] = 'Manage templates';
$string['datafos:manageuserpresets'] = 'Manage presets';
$string['datafos:rate'] = 'Rate entries';
$string['datafos:readentry'] = 'Read entries';
$string['datafos:viewalluserpresets'] = 'View presets from all users';
$string['datafos:viewallratings'] = 'View all raw ratings given by individuals';
$string['datafos:viewanyrating'] = 'View total ratings that anyone received';
$string['datafos:viewentry'] = 'View entries';
$string['datafos:viewrating'] = 'View the total rating you received';
$string['datafos:writeentry'] = 'Write entries';
$string['datafos:view'] = 'View database activity';
$string['date'] = 'Date';
...
$string['fieldmappings_help'] = 'This menu allows you to keep the datafos from the existing database. To preserve the datafos in a field, you must map it to a new field, where the datafos will appear. Any field can also be left blank, with no information copied into it. Any old field not mapped to a new one will be lost and all its datafos removed.
...
$string['fieldshelp'] = 'Create fields to collect different types of datafos. Fields define the structure of the entries in your database.';
...
$string['invalidid'] = 'Incorrect datafos ID';
...
$string['mappingwarning'] = 'All old fields not mapped to a new field will be lost and all datafos in that field will be removed.';
...
$string['missingfield'] = 'Programmer error: You must specify field and/or datafos when defining field class.';
...
$string['modulename_link'] = 'mod/datafos/view';
...
$string['newfield_help'] = 'A field allows the input of datafos. Each entry in a database activity can have multiple fields of multiple types such as a date field, which allows participants to select a day, month and year from a drop-down menu, a picture field, which allows participants to upload an image file, or a checkbox field, which allows participants to select one or more options.
...
$string['page-mod-datafos-x'] = 'Any database activity module page';
...
$string['privacy:metadata:data_content_fos'] = 'The content of a field';
$string['privacy:metadata:data_content_fos:fieldid'] = 'Field definition ID';
$string['privacy:metadata:data_content_fos:content'] = 'Content';
$string['privacy:metadata:data_content_fos:content1'] = 'Additional content 1';
$string['privacy:metadata:data_content_fos:content2'] = 'Additional content 2';
$string['privacy:metadata:data_content_fos:content3'] = 'Additional content 3';
$string['privacy:metadata:data_content_fos:content4'] = 'Additional content 4';
$string['privacy:metadata:data_records_fos'] = 'Records in the database activity';
$string['privacy:metadata:data_records_fos:userid'] = 'User who created the record';
$string['privacy:metadata:data_records_fos:groupid'] = 'Group';
$string['privacy:metadata:data_records_fos:timecreated'] = 'Time when record was created';
$string['privacy:metadata:data_records_fos:timemodified'] = 'Time when record was last modified';
$string['privacy:metadata:data_records_fos:approved'] = 'Approval status';
...
$string['uploadrecords_link'] = 'mod/datafos/import';
$string['url'] = 'URL';
