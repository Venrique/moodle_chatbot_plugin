...
class datafos_existing_preset_form extends moodleform {
    public function definition() {
        $this->_form->addElement('header', 'presets', get_string('usestandard', 'datafos'));
        $this->_form->addHelpButton('presets', 'usestandard', 'datafos');
        ...
        foreach ($this->_customdata['presets'] as $preset) {
            $userid = $preset instanceof \mod_datafos\preset ? $preset->get_userid() : $preset->userid;
 ...
 *             form (\mod_datafos\form\import_presets)
...
class data_import_preset_zip_form extends moodleform {
     ...
     */
    public function definition() {
        $this->_form->addElement('header', 'uploadpreset', get_string('fromfile', 'datafos'));
        $this->_form->addHelpButton('uploadpreset', 'fromfile', 'datafos');
        ...
        $this->_form->setType('action', PARAM_ALPHANUM);
        $this->_form->addElement('filepicker', 'importfile', get_string('chooseorupload', 'datafos'));
...
class data_export_form extends moodleform {
    public function definition() {
        $this->_form->addElement('header', 'exportheading', get_string('exportaszip', 'datafos'));
        $this->_form->addElement('hidden', 'd');
        $this->_form->setType('d', PARAM_INT);
        $this->_form->addElement('hidden', 'action', 'export');
        $this->_form->setType('action', PARAM_ALPHANUM);
        $this->_form->addElement('submit', 'export', get_string('export', 'datafos'));
    }
}
...
class data_save_preset_form extends moodleform {
    public function definition() {
        ...
        $this->_form->addElement('checkbox', 'overwrite', get_string('overwrite', 'datafos'), get_string('overrwritedesc', 'datafos'));
