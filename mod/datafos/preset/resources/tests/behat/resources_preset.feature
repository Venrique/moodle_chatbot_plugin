@mod @mod_datafos @datapreset @datapreset_resources
Feature: Users can use the Resources preset
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | datafos     | Student resources    | Database intro | C1     | data1    |
    And I am on the "Student resources" "datafos activity" page logged in as teacher1
  ...
  Scenario: Resources. Users view entries
    When I am on the "Student resources" "datafos activity" page logged in as student1
  ...
  Scenario: Resources. Users can search entries
    Given I am on the "Student resources" "datafos activity" page logged in as student1
  ...
  Scenario: Resources. Renaming a field should affect the template
    Given I am on the "Student resources" "datafos activity" page logged in as teacher1
