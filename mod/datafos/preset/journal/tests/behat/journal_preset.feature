@mod @mod_datafos @datapreset @datapreset_journal
Feature: Users can use the Journal preset
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | datafos     | Student reflections    | Database intro | C1     | data1    |
    And I am on the "Student reflections" "datafos activity" page logged in as teacher1
  ...
  Scenario: Journal. Users view entries
    When I am on the "Student reflections" "datafos activity" page logged in as student1
  ...
  Scenario: Journal. Users can search entries
    Given I am on the "Student reflections" "datafos activity" page logged in as student1
  ...
  Scenario: Journal. Renaming a field should affect the template
    Given I am on the "Student reflections" "datafos activity" page logged in as teacher1
