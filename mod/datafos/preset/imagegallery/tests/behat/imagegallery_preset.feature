@mod @mod_datafos @datapreset @data_preset_imagegallery
Feature: Users can use the Image gallery preset
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | datafos     | Mountain landscapes | Database intro | C1     | data1    |
  ...
  Scenario: Users view entries
    When I am on the "Mountain landscapes" "datafos activity" page logged in as student1
  ...
  Scenario: Users can search entries
    Given I am on the "Mountain landscapes" "datafos activity" page logged in as student1
