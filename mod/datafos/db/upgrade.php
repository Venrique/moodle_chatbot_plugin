...
function xmldb_data_upgrade($oldversion) {
    ...
    if ($oldversion < 2022081600) {
        // Define key userid (foreign) to be added to data_records_fos.
        $table = new xmldb_table('data_records_fos');
        $key = new xmldb_key('userid', XMLDB_KEY_FOREIGN, ['userid'], 'user', ['id']);
        // Launch add key userid.
        $dbman->add_key($table, $key);

        // Data savepoint reached.
        upgrade_mod_savepoint(true, 2022081600, 'datafos');
    }
    ...
    if ($oldversion < 2023061300) {
        ...
        // Data savepoint reached.
        upgrade_mod_savepoint(true, 2023061300, 'datafos');
    }
