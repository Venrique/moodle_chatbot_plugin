...
/**
 * CSV entries exporter for mod_datafos.
 *
 * @package    mod_datafos
...
class csv_entries_exporter extends entries_exporter {
    ...
    /**
     * Returns the csv datafos exported by the csv_export_writer for further handling.
     *
     * @see \mod_datafos\local\exporter\entries_exporter::get_data_file_content()
     */
     ...
     *
     * @see \mod_datafos\local\exporter\entries_exporter::get_export_data_file_extension()
     */
