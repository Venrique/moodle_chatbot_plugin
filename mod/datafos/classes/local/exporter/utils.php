...
/**
 * Utility class for exporting datafos from a mod_datafos instance.
 *
 * @package    mod_datafos
...
class utils {
    ...
    public static function data_exportdata(int $dataid, array $fields, array $selectedfields, entries_exporter $exporter,
        ...
        foreach ($datarecords as $record) {
            ...
            if ($currentgroup) {
                $select = 'SELECT c.fieldid, c.content, c.content1, c.content2, c.content3, c.content4 FROM {data_content_fos} c, '
                    . '{data_records_fos} r WHERE c.recordid = ? AND r.id = c.recordid AND r.groupid = ?';
                ...
                foreach ($fields as $field) {
                    ...
                    if (isset($content[$field->field->id])) {
                        ...
                        if (!empty($contents) && $field->file_export_supported() && $includefiles
                            ...
                            // mod_datafos instance content. But it's more important to match the name
