...
namespace mod_datafos\local\exporter;
...
/**
 * Exporter class for exporting datafos and - if needed - files as well in a zip archive.
 *
 * @package    mod_datafos
...
abstract class entries_exporter {
    ...
    /** @var int Tracks the currently edited row of the export datafos file. */
    private int $currentrow;

    /**
     * @var array The datafos structure containing the datafos for exporting. It's a 2-dimensional array of
     *  rows and columns.
     */
     ...
     *
     * This object can be used to export datafos to different formats including files. If files are added,
    ...
    /**
     * Adds a row (array of strings) to the export datafos.
     *
    ...
    /**
     * Adds a datafos string (so the content for a "cell") to the current row.
     *
    ...
    /**
     * The entries_exporter will prepare a datafos file from the rows and columns being added.
     * Overwrite this method to generate the datafos file as string.
     *
     * @return string the datafos file as a string
     */
    abstract protected function get_data_file_content(): string;

    /**
     * Overwrite the method to return the file extension your datafos file will have, for example
     * <code>return 'csv';</code> for a csv file entries_exporter.
     *
     * @return string the file extension of the datafos file your entries_exporter is using
     */
     ...
     * @throws moodle_exception if there is an issue adding the datafos file
