...
namespace mod_datafos\completion;

use core_completion\activity_custom_completion;

/**
 * Activity custom completion subclass for the datafos activity.
 *
 * Class for defining mod_datafos's custom completion rules and fetching the completion statuses
 * of the custom completion rules for a given datafos instance and a user.
 *
 * @package mod_datafos
...
class custom_completion extends activity_custom_completion {
    ...
    public function get_custom_rule_descriptions(): array {
        ...
        return [
            'completionentries' => get_string('completiondetail:entries', 'datafos', $entries),
        ];
    }
