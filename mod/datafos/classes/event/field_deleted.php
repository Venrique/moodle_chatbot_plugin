...
/**
 * The mod_datafos field deleted event.
 *
 * @package    mod_datafos
...
/**
 * The mod_datafos field deleted event class.
 *
...
class field_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfielddeleted', 'mod_datafos');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the field with id '$this->objectid' in the datafos activity " .
