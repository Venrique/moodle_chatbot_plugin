...
/**
 * The mod_datafos record created event.
 *
 * @package    mod_datafos
...
/**
 * The mod_datafos record created event class.
 *
...
class record_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventrecordcreated', 'mod_datafos');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the datafos record with id '$this->objectid' for the datafos activity " .
