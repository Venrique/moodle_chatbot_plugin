...
/**
 * The mod_datafos record updated event.
 *
 * @package    mod_datafos
...
/**
 * The mod_datafos record updated event class.
 *
...
class record_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventrecordupdated', 'mod_datafos');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the datafos record with id '$this->objectid' in the datafos activity " .
