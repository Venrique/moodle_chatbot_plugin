...
/**
 * The mod_datafos field updated event.
 *
 * @package    mod_datafos
...
/**
 * The mod_datafos field updated event class.
 *
...
class field_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfieldupdated', 'mod_datafos');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the field with id '$this->objectid' in the datafos activity " .
