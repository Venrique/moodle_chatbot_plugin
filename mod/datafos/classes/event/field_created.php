...
/**
 * The mod_datafos field created event.
 *
 * @package    mod_datafos
 * @since      Moodle 2.7
...
/**
 * The mod_datafos field created event class.
 *
...
class field_created extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'data_fields_fos';
        $this->data['crud'] = 'c';
    ...
    public static function get_name() {
        return get_string('eventfieldcreated', 'mod_datafos');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the field with id '$this->objectid' for the datafos activity " .
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'data_fields_fos', 'restore' => 'datafos_field');
    }
