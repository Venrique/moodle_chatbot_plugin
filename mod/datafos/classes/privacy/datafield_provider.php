...
interface datafield_provider extends
        ...
        // The datafos subplugins do not need to do anything themselves for the shared_userlist.
     ...
     *        ->rewrite_pluginfile_urls([$recordobj->id, $contentobj->id], 'mod_datafos', 'content', $contentobj->id,
