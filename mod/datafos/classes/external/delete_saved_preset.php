        ...
        foreach ($params['presetnames'] as $presetname) {
            try {
                ...
                if ($preset->can_manage()) {
                    if ($preset->delete()) {
                        notification::success(get_string('presetdeleted', 'mod_datafos'));
                        $result = true;
                    } else {
                        ...
                        $warnings[] = [
                            ...
                            'message' => get_string('failedpresetdelete', 'mod_datafos')
                        ];
                        notification::error(get_string('failedpresetdelete', 'mod_datafos'));
                    }
                } else {
                    ...
                    $warnings[] = [
                        ...
                        'message' => get_string('cannotdeletepreset', 'mod_datafos')
                    ];
                    notification::error(get_string('cannotdeletepreset', 'mod_datafos'));
                }
