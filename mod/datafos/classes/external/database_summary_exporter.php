...
/**
 * Class for exporting partial database datafos.
 *
 * @package    mod_datafos
...
/**
 * Class for exporting partial database datafos (some fields are only viewable by admins).
 *
 * @copyright  2017 Juan Leyva <juan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class database_summary_exporter extends exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $values = array(
            ...
            'introfiles' => external_util::get_area_files($context->id, 'mod_datafos', 'intro', false, false),
        );
