...
class defaulttemplate implements templatable, renderable {
    ...
    /** @var bool $isform Whether a form should be displayed instead of datafos. */
    private $isform;
     ...
     * @param bool $isform Whether a form should be displayed instead of datafos.
     */
    ...
    public function get_templatename(): string {
        return 'mod_datafos/defaulttemplate_' . $this->templatename;
    }
     ...
     * @return array The datafos to display.
     */
    public function export_for_template(\renderer_base $output): array {
        ...
        if (core_tag_tag::is_enabled(manager::PLUGINNAME, 'data_records_fos')) {
            // Add tags information only if they are enabled.
            if ($this->isform) {
                $tags = datafos_generate_tag_form();
            } else {
                $tags = '##tags##';
            }
            $result['tags'] = $tags;
