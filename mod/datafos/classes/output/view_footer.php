...
class view_footer extends sticky_footer {
    ...
    /**
     * Export this datafos so it can be used as the context for a mustache template (core/inplace_editable).
     *
     * @param renderer_base $output typically, the renderer that's calling this function
     * @return array datafos context for a mustache template
     */
    ...
    public function get_footer_output(renderer_base $output): string {
        ...
        if (datafos_user_can_add_entry($instance, $currentgroup, $groupmode, $context)) {
            $addentrylink = new moodle_url(
                '/mod/datafos/edit.php',
        ...
        return $output->render_from_template('mod_datafos/view_footer', $data);
    }
}
