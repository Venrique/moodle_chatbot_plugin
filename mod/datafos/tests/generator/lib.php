...
/**
 * Data generator class for mod_datafos.
 *
 * @package    mod_datafos
 * @category   test
...
class mod_data_generator extends testing_module_generator {
    ...
    /**
     * To be called from datafos reset code only,
     * do not use in tests.
     * @return void
     */
    ...
    /**
     * Creates a mod_datafos instance
     *
     * @param array $record
     * @param array $options
     * @return StdClass
    ...
    /**
     * Creates a field for a mod_datafos instance.
     *
     * @param StdClass $record
     * @param mod_datafos $data
     * @return datafos_field_{type}
     */
    public function create_field(stdClass $record = null, $data = null) {
        ...
        $field = datafos_get_field($record, $data);
        $field->insert_field();
    ...
    /**
     * Creates a field for a mod_datafos instance.
     * Keep in mind the default datafos field params created in create_field() function!
     * ...if you haven't provided your own custom datafos field parameters there.
     ...
     *
     * @param stdClass $data record from table {datafos}
     * @param array $contents
     * @param int $groupid
     * @param array $tags
     * @param array $options
     * @param int $userid if defined, it will be the author of the entry
     * @return int id of the generated record in table {data_records_fos}
     */
    public function create_entry($data, array $contents, $groupid = 0, $tags = [], array $options = null, int $userid = 0) {
        ...
        $recordid = datafos_add_record($data, $groupid);
        ...
        foreach ($fields as $field) {
            ...
            $field = datafos_get_field($field, $data);
            ...
            if ($field->type === 'date') {
                ...
                if (strlen($itemid) && !is_numeric($itemid)) {
                    ...
                    get_file_storage()->create_file_from_string(['component' => 'user', 'filearea' => 'draft',
                        ...
                        'filename' => $filename],
                        file_get_contents($CFG->dirroot.'/mod/datafos/pix/monologo.png'));
                }
        ...
        foreach ($contents as $fieldid => $content) {
            $field = datafos_get_field_from_id($fieldid, $data);
        ...
        if (!empty($tags)) {
            ...
            core_tag_tag::set_item_tags('mod_datafos', 'data_records_fos', $recordid,
    ...
    /**
     * Creates a preset from a mod_datafos instance.
     *
     * @param stdClass $instance The mod_datafos instance.
