...
class restore_date_test extends \restore_date_testcase {
    ...
    public function test_restore_dates() {
        ...
        $gg = $this->getDataGenerator()->get_plugin_generator('mod_datafos');
        ...
        list($course, $data) = $this->create_course_and_module('datafos', $record);
        ...
        $datarecord = $DB->get_record('data_records_fos', ['id' => $datarecordid]);
        ...
        $newdata = $DB->get_record('datafos', ['course' => $newcourseid]);
