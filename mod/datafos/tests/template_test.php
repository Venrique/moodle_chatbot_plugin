...
/**
 * Template tests class for mod_datafos.
 *
 * @package    mod_datafos
 * @category   test
 * @copyright  2022 Ferran Recio <ferran@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_datafos\template
 */
class template_test extends \advanced_testcase {
    ...
    public function test_parse_entries(
        ...
        if ($enablecomments) {
            ...
            $PAGE->set_url('/mod/datafos/view.php');
        }

        $course = $this->getDataGenerator()->create_course();
        $params['course'] = $course;
        $activity = $this->getDataGenerator()->create_module('datafos', $params);
        $cm = get_coursemodule_from_id('datafos', $activity->cmid, 0, false, MUST_EXIST);
    ...
    public function parse_entries_provider(): array {
        return [
            ...
            'Teacher moreurl tag' => [
                ...
                'expected' => '|Some .*/mod/datafos/view.*{cmid}.*rid.*{entryid}.* tag|',
                'rolename' => 'editingteacher',
                'enableexport' => false,
                'approved' => true,
                'enablecomments' => false,
    ...
    /**
     * Create all the necessary datafos to enable portfolio export in mod_datafos
     *
    ...
    protected function enable_portfolio(stdClass $user) {
        ...
        $DB->insert_record('portfolio_log', [
            ...
            'userid' => $user->id,
            'caller_class' => 'datafos_portfolio_caller',
            'caller_component' => 'mod_datafos',
            'time' => time(),
        ]);
    }
    ...
    protected function enable_ratings(context_module $context, stdClass $activity, array $entries, stdClass $user) {
        ...
        $ratingoptions = (object)[
            ...
            'userid' => $user->id,
            'returnurl' => $CFG->wwwroot . '/mod/datafos/view.php',
