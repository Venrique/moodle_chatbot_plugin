...
class lib_test extends \advanced_testcase {
    ...
    public function test_data_completion() {
        ...
        $record->name = "Mod datafos completion test";
         ...
         */
        $module = $this->getDataGenerator()->create_module('datafos', $record, array('completion' => 2, 'completionentries' => 1));

        $cm = get_coursemodule_from_instance('datafos', $module->id, $course->id);
        ...
        $field = datafos_get_field_new('text', $module);
        ...
        $field->insert_field();
        $recordid = datafos_add_record($module);

        $datacontent = array();
        $datacontent['fieldid'] = $field->field->id;
        $datacontent['recordid'] = $recordid;
        $datacontent['content'] = 'Asterix';
        $contentid = $DB->insert_record('data_content_fos', $datacontent);
    ...
    public function test_data_delete_record() {
        ...
        $record = new \stdClass();
        $record->course = $course->id;
        $record->name = "Mod datafos delete test";
        $record->intro = "Some intro of some sort";

        $module = $this->getDataGenerator()->create_module('datafos', $record);
        ...
        $data = $DB->get_records('datafos', array('id' => $module->id));
        $this->assertEquals(1, count($data));

        $datacontent = $DB->get_records('data_content_fos', array('id' => $contentid));
        $this->assertEquals(1, count($datacontent));

        $datafields = $DB->get_records('data_fields_fos', array('id' => $field->field->id));
        $this->assertEquals(1, count($datafields));

        $datarecords = $DB->get_records('data_records_fos', array('id' => $recordid));
        $this->assertEquals(1, count($datarecords));

        // Test to see if a failed delete returns false.
        $result = datafos_delete_record(8798, $module, $course->id, $cm->id);
        $this->assertFalse($result);

        // Delete the record.
        $result = datafos_delete_record($recordid, $module, $course->id, $cm->id);
    ...
    public function test_data_comment_created_event() {
        ...
        $this->assertInstanceOf('\mod_datafos\event\comment_created', $event);
        $this->assertEquals($context, $event->get_context());
        $url = new \moodle_url('/mod/datafos/view.php', array('id' => $cm->id));
    ...
    public function test_data_comment_deleted_event() {
        ...
        // Checking that the event contains the expected values.
        $this->assertInstanceOf('\mod_datafos\event\comment_deleted', $event);
        $this->assertEquals($context, $event->get_context());
        $url = new \moodle_url('/mod/datafos/view.php', array('id' => $module->cmid));
        $this->assertEquals($url, $event->get_url());
        $this->assertEventContextNotUsed($event);
    }
     ...
     * has the mod/datafos:manageentries capability.
     */
    public function test_data_user_can_manage_entry_return_true_with_capability() {
        ...
        assign_capability('mod/datafos:manageentries', CAP_ALLOW, $roleid, $context);

        $this->assertTrue(datafos_user_can_manage_entry($record, $data, $context),
            'data_user_can_manage_entry() returns true if the user has mod/datafos:manageentries capability');
    }

    /**
     * Checks that data_user_can_manage_entry will return false if the datafos
     * is set to readonly.
     */
    public function test_data_user_can_manage_entry_return_false_readonly() {
        ...
        // the other checks.
        assign_capability('mod/datafos:manageentries', CAP_PROHIBIT, $roleid, $context);
        ...
        $this->assertFalse(datafos_user_can_manage_entry($record, $data, $context),
            'data_user_can_manage_entry() returns false if the datafos is read only');
    }
    ...
    public function test_data_user_can_manage_entry_return_false_no_record() {
        ...
        $this->assertFalse(datafos_user_can_manage_entry(1, $data, $context),
    ...
    /**
     * Checks that data_user_can_manage_entry will return true if the datafos
    ...
    public function test_data_user_can_manage_entry_return_manageapproved() {
        ...
        $canmanageentry = datafos_user_can_manage_entry($record, $data, $context);
    ...
    /**
     * Helper method to create a set of test datafos for data_user_can_manage tests
     *
    ...
    public function test_mod_data_rating_can_see_item_ratings() {
        ...
        $data = $this->getDataGenerator()->create_module('datafos', array('course' => $course->id));
        ...
        // Add datafos.
        $field = datafos_get_field_new('text', $data);
        ...
        $recordid1 = datafos_add_record($data, 0);

        $datacontent = array();
        $datacontent['fieldid'] = $field->field->id;
        $datacontent['recordid'] = $recordid1;
        $datacontent['content'] = 'Obelix';
        $DB->insert_record('data_content_fos', $datacontent);

        $recordid = datafos_add_record($data, $group1->id);
        ...
        $this->setUser($user1);
        $this->assertTrue(mod_datafos_rating_can_see_item_ratings($params));
        $this->assertTrue(mod_datafos_rating_can_see_item_ratings($params1));
        $this->setUser($user2);
        $this->assertTrue(mod_datafos_rating_can_see_item_ratings($params));
        $this->assertTrue(mod_datafos_rating_can_see_item_ratings($params1));
        $this->setUser($user3);
        $this->assertFalse(mod_datafos_rating_can_see_item_ratings($params));
        $this->assertTrue(mod_datafos_rating_can_see_item_ratings($params1));
        $this->setUser($user4);
        $this->assertFalse(mod_datafos_rating_can_see_item_ratings($params));
        $this->assertTrue(mod_datafos_rating_can_see_item_ratings($params1));
    ...
    public function test_data_refresh_events() {
        ...
        $course = $this->getDataGenerator()->create_course();
        $generator = $this->getDataGenerator()->get_plugin_generator('mod_datafos');
        ...
        $this->assertTrue(datafos_refresh_events($course->id));
        $eventparams = array('modulename' => 'datafos', 'instance' => $data->id, 'eventtype' => 'open');
        $openevent = $DB->get_record('event', $eventparams, '*', MUST_EXIST);
        $this->assertEquals($openevent->timestart, $timeopen);

        $eventparams = array('modulename' => 'datafos', 'instance' => $data->id, 'eventtype' => 'close');
        ...
        $this->assertTrue(datafos_refresh_events());
        $eventparams = array('modulename' => 'datafos');
        $events = $DB->get_records('event', $eventparams);
        foreach ($events as $event) {
            if ($event->modulename === 'datafos' && $event->instance === $data->id && $event->eventtype === 'open') {
                $this->assertEquals($event->timestart, $timeopen);
            }
            if ($event->modulename === 'datafos' && $event->instance === $data->id && $event->eventtype === 'close') {
    ...
    /**
     * Data provider for tests of datafos_get_config.
     *
     * @return array
     */
    public function datafos_get_config_provider() {
        $initialdata = (object) [
            'template_foo' => true,
            'template_bar' => false,
            'template_baz' => null,
    ...
    /**
     * Tests for datafos_get_config.
     *
     * @dataProvider    datafos_get_config_provider
     * @param   array   $funcargs       The args to pass to datafos_get_config
     * @param   mixed   $expectation    The expected value
     */
    public function test_datafos_get_config($funcargs, $expectation) {
        $this->assertEquals($expectation, call_user_func_array('datafos_get_config', $funcargs));
    }
    ...
    public function test_data_set_config($database, $key, $value, $expectupdate, $newconfigvalue) {
        ...
        // Perform the update.
        datafos_set_config($database, $key, $value);
    ...
    public function test_mod_datafos_get_tagged_records() {
        $this->resetAfterTest();
        $this->setAdminUser();

        // Setup test datafos.
        $datagenerator = $this->getDataGenerator()->get_plugin_generator('mod_datafos');
        ...
        $data1 = $this->getDataGenerator()->create_module('datafos', array('course' => $course1->id, 'approval' => true));
        ...
        $res = mod_datafos_get_tagged_records($tag, false, 0, 0, 1, 0);
    ...
    public function test_mod_datafos_get_tagged_records_approval() {
        global $DB;
        ...
        $data1 = $this->getDataGenerator()->create_module('datafos', array('course' => $course1->id));
        $field1 = $datagenerator->create_field($fieldrecord, $data1);
        $data2 = $this->getDataGenerator()->create_module('datafos', array('course' => $course2->id, 'approval' => true));
        ...
        // User can search datafos records inside a course.
        ...
        $DB->update_record('data_records_fos', $recordtoupdate);
    ...
    public function test_mod_datafos_get_tagged_records_time() {
        global $DB;
        ...
        $data1 = $this->getDataGenerator()->create_module('datafos', array('course' => $course1->id, 'approval' => true));
        $field1 = $datagenerator->create_field($fieldrecord, $data1);
        $data2 = $this->getDataGenerator()->create_module('datafos', array('course' => $course2->id,
        ...
        $DB->update_record('datafos', $data2);
    ...
    public function test_mod_datafos_get_tagged_records_course_enrolment() {
        global $DB;
    ...
    public function test_mod_datafos_get_tagged_records_course_groups() {
        global $DB;
    ...
    public function test_check_updates_since() {
        ...
        $data = $this->getDataGenerator()->create_module('datafos', $record);
        $cm = get_coursemodule_from_instance('datafos', $data->id, $course->id);
    ...
    public function test_data_core_calendar_provide_event_action_in_hidden_section() {
        ...
        $event = $this->create_action_event($course->id, $data->id, DATAFOS_EVENT_TYPE_OPEN);
        ...
        $actionevent = mod_datafos_core_calendar_provide_event_action($event, $factory, $student->id);
    ...
    public function test_data_core_calendar_provide_event_action_for_non_user() {
        ...
        $actionevent = mod_datafos_core_calendar_provide_event_action($event, $factory);
    ...
    public function test_data_core_calendar_provide_event_action_open() {
        ...
        $this->assertEquals(get_string('add', 'datafos'), $actionevent->get_name());
     ...
     *
     * @param int $courseid
     * @param int $instanceid The datafos id.
     * @param string $eventtype The event type. eg. DATAFOS_EVENT_TYPE_OPEN.
    ...
    public function test_mod_data_completion_get_active_rule_descriptions() {
        ...
        $data1 = $this->getDataGenerator()->create_module('datafos', [
            'course' => $course->id,
            'completion' => 2,
            'completionentries' => 3
        ]);
        $data2 = $this->getDataGenerator()->create_module('datafos', [
            'course' => $course->id,
            'completion' => 2,
            'completionentries' => 0
        ]);
        $cm1 = \cm_info::create(get_coursemodule_from_instance('datafos', $data1->id));
        $cm2 = \cm_info::create(get_coursemodule_from_instance('datafos', $data2->id));
        ...
        $activeruledescriptions = [get_string('completionentriesdesc', 'datafos', 3)];
        $this->assertEquals(mod_datafos_get_completion_active_rule_descriptions($cm1), $activeruledescriptions);
        $this->assertEquals(mod_datafos_get_completion_active_rule_descriptions($cm2), []);
        $this->assertEquals(mod_datafos_get_completion_active_rule_descriptions($moddefaults), $activeruledescriptions);
        $this->assertEquals(mod_datafos_get_completion_active_rule_descriptions(new \stdClass()), []);
    }

    /**
     * An unknown event type should not change the datafos instance.
     */
    public function test_mod_data_core_calendar_event_timestart_updated_unknown_event() {
        ...
        $datagenerator = $generator->get_plugin_generator('mod_datafos');
        $timeopen = time();
        ...
        $event = new \calendar_event([
            ...
            'modulename' => 'datafos',
            'instance' => $data->id,
            'eventtype' => DATAFOS_EVENT_TYPE_OPEN . "SOMETHING ELSE",
            'timestart' => 1,
            'timeduration' => 86400,
            'visible' => 1
        ]);

        mod_datafos_core_calendar_event_timestart_updated($event, $data);
        $data = $DB->get_record('datafos', ['id' => $data->id]);
        $this->assertEquals($timeopen, $data->timeavailablefrom);
        $this->assertEquals($timeclose, $data->timeavailableto);
    }

    /**
     * A DATAFOS_EVENT_TYPE_OPEN event should update the timeavailablefrom property of the datafos activity.
     */
    public function test_mod_data_core_calendar_event_timestart_updated_open_event() {
        ...
        $event = new \calendar_event([
            ...
            'modulename' => 'datafos',
            'instance' => $data->id,
            'eventtype' => DATAFOS_EVENT_TYPE_OPEN,
    ...
    /**
     * A DATAFOS_EVENT_TYPE_CLOSE event should update the timeavailableto property of the datafos activity.
     */
    public function test_mod_data_core_calendar_event_timestart_updated_close_event() {
        ...
        $event = new \calendar_event([
            ...
            'modulename' => 'datafos',
            'instance' => $data->id,
            'eventtype' => DATAFOS_EVENT_TYPE_CLOSE,
    ...
    public function test_mod_data_core_calendar_get_valid_event_timestart_range_unknown_event() {
        ...
        list ($min, $max) = mod_datafos_core_calendar_get_valid_event_timestart_range($event, $data);
        $this->assertNull($min);
        $this->assertNull($max);
    }

    /**
     * The open event should be limited by the datafos's timeclose property, if it's set.
     */
    ...
    /**
     * The close event should be limited by the datafos's timeavailablefrom property, if it's set.
     */
    ...
    public function test_creation_with_no_calendar_capabilities() {
        ...
        $generator = self::getDataGenerator()->get_plugin_generator('mod_datafos');
     ...
     *
     * @covers ::datafos_generate_default_template
     */
    public function test_data_generate_default_template(): void {
        ...
        $nullactivity = null;
        $result = datafos_generate_default_template($nullactivity, 'listtemplate', 0, false, false);
        $this->assertEmpty($result);
        $result = datafos_generate_default_template($activity, null, 0, false, false);
        $this->assertEmpty($result);
        $result = datafos_generate_default_template($nullactivity, null, 0, false, false);
        $this->assertEmpty($result);
        ...
        foreach ($emptytemplates as $emptytemplate) {
            $result = datafos_generate_default_template($activity, $emptytemplate, 0, false, false);
            $this->assertEmpty($result);
        }
        ...
        foreach ($templates as $template) {
            $result = datafos_generate_default_template($activity, $template, 0, false, false);
            $this->assertEmpty($result);
        ...
        foreach ($templates as $template) {
            $result = datafos_generate_default_template($activity, $template, 0, false, true);
            $this->assertNotEmpty($result);
     ...
     *
     * @covers ::datafos_replace_field_in_templates
     */
    public function test_data_replace_field_in_templates(): void {
        ...
        datafos_replace_field_in_templates($activity, 'myfield', 'newfieldname');
     ...
     *
     * @covers ::datafos_append_new_field_to_templates
    ...
    public function test_data_append_new_field_to_templates(bool $hasfield, bool $hasotherfields, bool $expected) {
        ...
        $result = datafos_append_new_field_to_templates($activity, 'myfield');
