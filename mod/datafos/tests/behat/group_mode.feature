@mod @mod_datafos
Feature: Group datafos activity
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | datafos     | Separate datafos | Data with separate groups | C1     | data1    | 1         |
      | datafos     | Visible datafos  | Data with visible groups  | C1     | data2    | 2         |
  ...
  participation groups in "visible groups" mode.
    Given I am on the "<datafos>" "datafos activity" page logged in as "<user>"
    ...
    Examples:
      | datafos  | user     | all            | G1             | G2             | user1          | user2          |
  ...
  a user should only have the "Add entry" button for their own participation groups
    Given I am on the "data2" "datafos activity" page logged in as "<user>"
