@mod @mod_datafos @core_completion @javascript
Feature: View activity completion in the database activity
  ...
  Background:
    ...
    And the following "activity" exists:
      ...
      | completionentries        | 2             |
    Given I am on the "Music history" "datafos activity editing" page logged in as teacher1
  ...
  Scenario: View automatic completion items as a teacher
    Given I am on the "Music history" "datafos activity" page logged in as teacher1
#   We add an entry to let the user change to a different view.
  ...
  Scenario: View automatic completion items as a student
    Given I am on the "Music history" "datafos activity" page logged in as student1
    ...
    And I am on the "Music history" "datafos activity" page logged in as teacher1
    And I select "Single view" from the "jump" singleselect
    And I set the field "rating" to "3"
    And I log out

    When I am on the "Music history" "datafos activity" page logged in as student1
    Then the "View" completion condition of "Music history" is displayed as "done"
    And the "Make entries: 2" completion condition of "Music history" is displayed as "done"
