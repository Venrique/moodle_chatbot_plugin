...
class entries_export_test extends \advanced_testcase {
    ...
    /**
     * Tests the exporting of the content of a mod_datafos instance by using the csv_entries_exporter.
     *
     * It also includes more general testing of the functionality of the entries_exporter the csv_entries_exporter
     * is inheriting from.
     *
     * @covers \mod_datafos\local\exporter\entries_exporter
     * @covers \mod_datafos\local\exporter\entries_exporter::get_records_count()
     * @covers \mod_datafos\local\exporter\entries_exporter::send_file()
     * @covers \mod_datafos\local\exporter\csv_entries_exporter
     * @covers \mod_datafos\local\exporter\utils::data_exportdata
     */
    public function test_export_csv(): void {
        ...
        $expectedfilecontents = [
            // The test generator for mod_datafos uses a copy of pix/monologo.png as sample file content for the file stored in a
            ...
            'files/samplefile.png' => 'mod/datafos/pix/monologo.png',
            'files/samplefile_1.png' => 'mod/datafos/pix/monologo.png',
            'files/picturefile.png' => 'mod/datafos/pix/monologo.png',
     ...
     *
     * @covers \mod_datafos\local\exporter\ods_entries_exporter
     * @covers \mod_datafos\local\exporter\utils::data_exportdata
     */
    ...
    /**
     * Helper function to extract the text datafos as row arrays from an ODS document.
     *
