...
use context_module;
use mod_datafos\local\exporter\csv_entries_exporter;
use mod_datafos\local\exporter\ods_entries_exporter;
use mod_datafos\local\exporter\utils;
...
class entries_importer_test extends \advanced_testcase {
     ...
     *
     * @covers \mod_datafos\local\importer\entries_importer::get_file_content_from_zip
     * @covers \mod_datafos\local\importer\entries_importer::get_data_file_content
    ...
    public function test_get_file_content_from_zip(array $files, mixed $datafilecontent): void {
        ...
        // We now created a zip archive according to the datafos provider's datafos. We now can test the importer.
    ...
    public function get_file_content_from_zip_provider(): array {
        return [
            'some files in the zip archive' => [
                ...
                'datafilecontent' => 'some,csv,datafos'
            ],
            'wrongly placed datafos file' => [
                'files' => [
                    [
                        'filename' => 'datafile.csv',
                        'filecontent' => 'some,csv,datafos',
            ...
            'two datafos files where only one is allowed' => [
                'files' => [
                    [
                        'filename' => 'datafile.csv',
                        'filecontent' => 'some,csv,datafos',
                    ...
                    [
                        ...
                        'filecontent' => 'some,other,csv,datafos',
                    ],
                    [
                        'filename' => 'testfile.txt',
                        'filecontent' => 'somecontent',
                ...
                // There are two datafos files in the zip root, so the datafos cannot be imported.
                'datafilecontent' => false
            ],
        ];
    }
