...
namespace mod_datafos\external;
 ...
 * @coversDefaultClass \mod_datafos\external\get_mapping_information
 */
class get_mapping_information_test extends \advanced_testcase {
    ...
    public function test_get_mapping_information(
        ...
        $this->assertEquals($result['datafos']['fieldstocreate'], $fieldstocreate);
        $this->assertEquals($result['datafos']['fieldstoremove'], $fieldstoremove);
    ...
    public function test_get_mapping_information_for_wrong_preset() {
        ...
        $this->assertFalse(array_key_exists('datafos', $result));
        ...
        $this->assertTrue(array_key_exists('datafos', $result));
