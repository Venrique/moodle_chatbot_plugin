...
use mod_datafos\completion\custom_completion;
...
/**
 * Class for unit testing mod_datafos/activity_custom_completion.
 *
 * @package   mod_datafos
 * @copyright Simey Lameze <simey@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class custom_completion_test extends advanced_testcase {
    ...
    public function test_get_state(string $rule, int $available, int $entries, ?int $status, ?string $exception) {
        ...
        // Custom completion rule datafos for cm_info::customdata.
        $customdataval = [
