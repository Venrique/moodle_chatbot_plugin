...
class datafos_field_latlong extends datafos_field_base {
    var $type = 'latlong';
    ...
    function display_browse_field($recordid, $template) {
        ...
        if (count($servicesshown) == 1 && $servicesshown[0]) {
            $str = " <a class=\"datafos-field-link\" href='"
                        . str_replace(
            ...
            $str = '<form id="latlongfieldbrowse" class="datafos-field-html">';
