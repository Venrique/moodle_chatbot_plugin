...
class datafos_field_url extends datafos_field_base {
    var $type = 'url';
    /**
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($autolinkable) {
            ...
            $str .= '<span class="mod-datafos-input">' . get_string('url', 'datafos') . ':</span>';
            if (!empty($image)) {
                $str .= $image;
            }
            $str .= '</td><td>';
            ...
            $str .= '<tr><td align="right"><span class="mod-datafos-input">' . get_string('text', 'datafos') . ':</span></td><td>';
            ...
            $str .= $label;
            $str .= '<input type="text" name="field_'.$this->field->id.'_0" id="'.$fieldid.'" value="'.s($url).'"';
            $str .= ' size="40" class="mod-datafos-input form-control d-inline" />';
        ...
        $module = array('name'=>'data_urlpicker', 'fullpath'=>'/mod/datafos/datafos.js', 'requires'=>array('core_filepicker'));
