...
class datafos_field_textarea extends datafos_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($formdata) {
            ...
            $text = file_prepare_draft_area($draftitemid, $this->context->id, 'mod_datafos', 'content', $content->id, $options, $text);
        } else {
            $draftitemid = file_get_unused_draft_itemid();
    ...
    function update_content($recordid, $value, $name='') {
        ...
        if (!empty($content->content)) {
            ...
            $options = $this->get_options();
            $content->content = file_save_draft_area_files($draftitemid, $this->context->id, 'mod_datafos', 'content', $content->id, $options, $content->content);
        }
        $rv = $DB->update_record('data_content_fos', $content);
        return $rv;
    }
    ...
    function display_browse_field($recordid, $template) {
        ...
        return '<div class="datafos-field-html">' . $str . '</div>';
    }
