...
class entries_exporter_test extends \advanced_testcase {
     ...
     * @param array $rows the rows from the datafos provider to be tested by the exporter
     ...
     * @covers \mod_datafos\local\exporter\entries_exporter::add_file_from_string
     * @covers \mod_datafos\local\exporter\entries_exporter::file_exists
     ...
     *
     * @covers \mod_datafos\local\exporter\entries_exporter::create_unique_filename
