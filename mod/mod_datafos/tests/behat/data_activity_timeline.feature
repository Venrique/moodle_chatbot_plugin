@mod @mod_datafos
Feature: Students can view upcoming datafos activities in the timeline block
  In order for student to see upcoming datafos activities in timeline block
  As a teacher
  I should be able to set the availability dates of datafos activities
  ...
  @javascript
  Scenario Outline: Student can view upcoming datafos activities in the timeline block
    Given the following "activities" exist:
      | activity | course | name       | id_timeavailablefrom_enabled | timeavailablefrom | id_timeavailableto_enabled | timeavailableto     |
      | datafos     | C1     | DB Past    | 1                            | <pastfrom>        | 1                          | <pastto>            |
      | datafos     | C1     | DB Future  | 1                            | <futurefrom>      | 1                          | <futureto>          |
      | datafos     | C1     | DB No date | 0                            |                   | 0                          |                     |
