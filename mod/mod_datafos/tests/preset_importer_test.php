...
/**
 * Preset importer tests class for mod_datafos.
 *
 * @package    mod_datafos
 * @category   test
 * @copyright  2022 Amaia Anabitarte <amaia@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_datafos\local\importer\preset_importer
 */
class preset_importer_test extends \advanced_testcase {
    ...
    public function test_create_from_plugin_or_directory() {
        ...
        $this->assertInstanceOf('\mod_datafos\local\importer\preset_existing_importer', $preset);
