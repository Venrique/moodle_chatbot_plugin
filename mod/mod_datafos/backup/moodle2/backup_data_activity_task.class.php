...
require_once($CFG->dirroot . '/mod/datafos/backup/moodle2/backup_data_stepslib.php');
...
class backup_datafos_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance datafos in the datafos.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_data_activity_structure_step('data_structure', 'datafos.xml'));
    }
