...
/**
 * Define the complete datafos structure for backup, with file and id annotations
 */
class backup_data_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $data = new backup_nested_element('datafos', array('id'), array(
        ...
        // Define sources
        $data->set_source_table('datafos', array('id' => backup::VAR_ACTIVITYID));
        ...
        if ($userinfo) {
            ...
            $rating->set_source_table('rating', array('contextid'  => backup::VAR_CONTEXTID,
                                                      ...
                                                      'component'  => backup_helper::is_sqlparam('mod_datafos'),
            ...
            if (core_tag_tag::is_enabled('mod_datafos', 'data_records_fos')) {
                $tag->set_source_sql('SELECT t.id, ti.itemid, t.rawname
                    ...
                    backup_helper::is_sqlparam('data_records_fos'),
                    backup_helper::is_sqlparam('mod_datafos'),
        ...
        $data->annotate_files('mod_datafos', 'intro', null); // This file area hasn't itemid
        $content->annotate_files('mod_datafos', 'content', 'id'); // By content->id

        // Return the root element (datafos), wrapped into standard activity structure
