@mod @mod_datafos @datapreset @datapreset_proposals
Feature: Users can use the Proposals preset
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | datafos     | Student projects    | Database intro | C1     | data1    |
    And I am on the "Student projects" "datafos activity" page logged in as teacher1
  ...
  Scenario: Proposals. Users view entries
    When I am on the "Student projects" "datafos activity" page logged in as student1
  ...
  Scenario: Proposals. Users can search entries
    Given I am on the "Student projects" "datafos activity" page logged in as student1
  ...
  Scenario: Proposals. Renaming a field should affect the template
    Given I am on the "Student projects" "datafos activity" page logged in as teacher1
