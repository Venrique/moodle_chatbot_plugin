...
class template_editor implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $data = [
            'title' => get_string('header' . $this->templatename, 'datafos'),
            'sesskey' => sesskey(),
            'disableeditor' => true,
            'url' => new moodle_url('/mod/datafos/templates.php', ['id' => $cm->id, 'mode' => $this->templatename]),
        ];
        ...
        if (($this->templatename !== 'csstemplate') && ($this->templatename !== 'jstemplate')) {
            $usehtmleditor = datafos_get_config($instance, "editor_{$this->templatename}", true);
            $disableeditor = true;
        }
