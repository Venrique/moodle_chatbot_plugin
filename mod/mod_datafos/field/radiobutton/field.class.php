...
class datafos_field_radiobutton extends datafos_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($formdata) {
            ...
            $content = trim($DB->get_field('data_content_fos', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid)));
        } else {
            $content = '';
        }
        ...
        foreach ($options as $radio) {
            ...
            $str .= 'value="' . s($radio) . '" class="mod-datafos-input mr-1" ';
